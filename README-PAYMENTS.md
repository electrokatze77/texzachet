...
- обмежує доступ до сайту й користувацьких API для IP-адрес з України;
...
Геоблокування не застосовується до callback-маршруту Platega, щоб не
переривати підтвердження вже створених платежів.
...
|---|---:|
| БАЗОВЫЙ | 2000 RUB |
| РАСШИРЕННЫЙ | 3000 RUB |
| МАКСИМАЛЬНЫЙ | 4300 RUB |
